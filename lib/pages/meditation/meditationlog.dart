...
class _MeditationLogState extends State<MeditationLog> {
  ...
  int greenCount = 0; // Counter for green items
  int redCount = 0;
  ...
  var data =  Provider.of<MeditationController>(context).medDates;

  // int countIsMeditatedTwo = 0;
  ...
  // Counter for red items
      ...
      children: List.generate(
        data.length,
          ...
          // Increment counters based on color
          if (isGreen) {
            greenCount++;
          } else {
            redCount++;
